...
def write_pdf_report(filename=None, score=None, shooting_image=None, plots_image=None, launch_angle=None):
    ...
    c.drawCentredString(width / 2.0, height - 40,
                        "Basketball Trajectory Report")
    ...
    c.drawImage(shooting_image, x, y=410, width=image_width,
                height=image_height)  # higher y value to move the image up
    ...
    c.drawImage(plots_image, x, y=200, width=image_width_plots,
                height=image_height_plots)
